...
UNDERSTAND_DOCUMENT = (
    ...
    "'Tax No', 'Student Name:', a phone number like '425-431-7650', or an organization "
    "name. Bad anchors: 'John Smith', '123 Main St' (these are values, not labels).\",\n"
    ...
    "school grade report where every page starts with the school header, then the phone "
    "number '425-431-7650', then parent name on the next line, student name below that, "
    "and address below that. The correct field map uses the phone number as anchor:\n"
    "  [{\"field_type\": \"PERSON\", \"anchor_text\": \"425-431-7650\", "
    "\"spatial_relationship\": \"line_below\", \"line_count\": 1}, "
    "{\"field_type\": \"PERSON\", \"anchor_text\": \"425-431-7650\", "
    "\"spatial_relationship\": \"lines_below_2\", \"line_count\": 1}, "
    "{\"field_type\": \"LOCATION\", \"anchor_text\": \"425-431-7650\", "
...
UNDERSTAND_MULTI_PAGE_DOCUMENT = (
    ...
    "with ONLY PERSON and LOCATION fields is valid and expected for educational and "
    "HR documents — do NOT require SSN, email, or other government ID fields to "
    "justify creating a layout_field_map. Example for a school grade report:\n"
    "  [{\"field_type\": \"PERSON\", \"anchor_text\": \"Student Name\", "
    "\"spatial_relationship\": \"same_line_right\", \"line_count\": 1}, "
    "{\"field_type\": \"LOCATION\", \"anchor_text\": \"Address\", "
    "\"spatial_relationship\": \"lines_below_3\", \"line_count\": 3}]\n"
